...
//  Project 28
//
//  Created by Евгения Зорич on 16.04.2023.
//
...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        doneButton = UIBarButtonItem(title: "Fast Secure", style: .plain, target: self, action: #selector(saveSecretMessage))
        
        password = UIBarButtonItem(title: "Set Password", style: .plain, target: self, action: #selector(setPassword))
    }
...
//                        let ac = UIAlertController(title: "Authentification failed!", message: "You could not be verifyed; please try again", preferredStyle: .alert)
...
//            self.present(ac, animated: true)
    ...
    func unlockSecretMessage() {
        ...
        navigationItem.leftBarButtonItem = password
